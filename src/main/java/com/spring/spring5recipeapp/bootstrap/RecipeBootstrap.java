...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.addIngredient( new Ingredient( "Serano chiles, stems and seed removed, minced", new BigDecimal( 2 ), eachUom ) );
        ...
        guacRecipe.setUrl("http://www.example.com");
        ...
        tacosRecipe.addIngredient( new Ingredient( "Fried oregano", new BigDecimal( 1 ), teaSpoonUom ) );
        tacosRecipe.addIngredient( new Ingredient( "Fried cumin", new BigDecimal( 1 ), teaSpoonUom ) );
        tacosRecipe.addIngredient( new Ingredient( "Sugar", new BigDecimal( ".5" ), teaSpoonUom ) );
        ...
        tacosRecipe.addIngredient( new Ingredient( "4 to 6 skinless, boneless chicken thighs (1 1/4 pounds)", new BigDecimal( 1 ), eachUom ) );
